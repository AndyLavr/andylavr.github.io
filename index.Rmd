---
title: "Dragon Linux Kernel 4.20.3"
...
[**Dragon Live DVD/USB stick Ubuntu/Kubuntu/Xubuntu/Lubuntu (Cosmic/Disco)**](https://dragon-kernel.pro/livedvd)
...
All workstations that I use today — a [MSI GT80-2QE-Titan-SLI (Broadwell)](https://www.msi.com/Laptop/GT80-2QE-Titan-SLI/Specification), [Dell Inspiron N5010 (Westmere)](https://technoish.com/dell-inspiron-n5010-review/), [Toshiba Satellite Click 10 LX0W-C - C64M (Atom Cherry Trail)](http://www.toshiba.co.uk/discontinued-products/satellite-click-10-lx0w-c-104/?categoryNameProductPage=laptops) and [Acer Aspire SW5-012/Fendi2 Z3537F (Atom)](https://www.cnet.com/products/acer-aspire-switch-10-sw5-012-12l7-10-1-atom-z3735f-2-gb-ram-32-gb-ssd/specs/)  - boots Dragon kernels instead. Dragon’s kernels mirror the upstream development cycle, and as a bonus, include a number of exciting optimizations and patches to improve performance and expose up-and-coming features.
...
**Main Features:**
 ...
 - DRM Optimized Performance, Nvidia kernel module is integrated into the kernel.
...
[![**Nvidia**](images/nv.jpeg)]()
 
## Linux X64 (AMD64/EM64T) display kernel module

 Full information is driver version **390.87** here - ([Nvidia Main site](https://www.nvidia.com/download/driverResults.aspx/137276/en-us))

 Dragon Linux Team provide their own packages of the NVIDIA Linux Graphics Driver in the distribution's native package management format. 
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-generic linux-image-unsigned-4.20.3-dragon-generic linux-modules-4.20.3-dragon-generic linux-modules-extra-4.20.3-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/generic
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-lowlatency linux-image-unsigned-4.20.3-dragon-lowlatency linux-modules-4.20.3-dragon-lowlatency linux-modules-extra-4.20.3-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-westmere linux-image-unsigned-4.20.3-dragon-westmere linux-modules-4.20.3-dragon-westmere linux-modules-extra-4.20.3-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wip-kernel-release
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-atom linux-image-unsigned-4.20.3-dragon-atom linux-modules-4.20.3-dragon-atom linux-modules-extra-4.20.3-dragon-atom
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-icelake linux-image-unsigned-4.20.3-dragon-icelake linux-modules-4.20.3-dragon-icelake linux-modules-extra-4.20.3-dragon-icelake
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/icelake-cannonlake
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-cannonlake linux-image-unsigned-4.20.3-dragon-cannonlake linux-modules-4.20.3-dragon-cannonlake linux-modules-extra-4.20.3-dragon-cannonlake
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-zen linux-image-unsigned-4.20.3-dragon-zen linux-modules-4.20.3-dragon-zen linux-modules-extra-4.20.3-dragon-zen
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/zen-excavator
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.3-dragon linux-headers-4.20.3-dragon-excavator linux-image-unsigned-4.20.3-dragon-excavator linux-modules-4.20.3-dragon-excavator linux-modules-extra-4.20.3-dragon-excavator
$ sudo reboot
```
