...
[![**exFAT - Extended File Allocation Table**](https://dragon-kernel.pro/images/exfat_a.jpeg)](https://en.wikipedia.org/wiki/ExFAT)
 
## Linux non-fuse read/write kernel driver for the exFAT, FAT12, FAT16 and vfat (FAT32) file systems ([AUFS](https://en.wikipedia.org/wiki/Aufs))
...
exFAT has been adopted by the SD Card Association as the default file system for SDXC cards larger than 32 GiB.
 ...
 - The module exFAT is integrated into the kernel.
