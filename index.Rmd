---
title: "Dragon Linux Kernel 4.20.13"
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.13-dragon linux-headers-4.20.13-dragon-generic linux-image-unsigned-4.20.13-dragon-generic linux-modules-4.20.13-dragon-generic linux-modules-extra-4.20.13-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/generic
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.13-dragon linux-headers-4.20.13-dragon-lowlatency linux-image-unsigned-4.20.13-dragon-lowlatency linux-modules-4.20.13-dragon-lowlatency linux-modules-extra-4.20.13-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.13-dragon linux-headers-4.20.13-dragon-westmere linux-image-unsigned-4.20.13-dragon-westmere linux-modules-4.20.13-dragon-westmere linux-modules-extra-4.20.13-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wip-kernel-release
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.13-dragon linux-headers-4.20.13-dragon-atom linux-image-unsigned-4.20.13-dragon-atom linux-modules-4.20.13-dragon-atom linux-modules-extra-4.20.13-dragon-atom
$ sudo reboot
```
