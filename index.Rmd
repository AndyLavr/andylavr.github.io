---
title: "Dragon Linux Kernel 4.20 Update 3" 
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-generic linux-image-unsigned-4.20.0-dragon-generic linux-modules-4.20.0-dragon-generic linux-modules-extra-4.20.0-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/generic
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-lowlatency linux-image-unsigned-4.20.0-dragon-lowlatency linux-modules-4.20.0-dragon-lowlatency linux-modules-extra-4.20.0-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-westmere linux-image-unsigned-4.20.0-dragon-westmere linux-modules-4.20.0-dragon-westmere linux-modules-extra-4.20.0-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wip-kernel-release
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-atom linux-image-unsigned-4.20.0-dragon-atom linux-modules-4.20.0-dragon-atom linux-modules-extra-4.20.0-dragon-atom
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-icelake linux-image-unsigned-4.20.0-dragon-icelake linux-modules-4.20.0-dragon-icelake linux-modules-extra-4.20.0-dragon-icelake
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/icelake-cannonlake
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-cannonlake linux-image-unsigned-4.20.0-dragon-cannonlake linux-modules-4.20.0-dragon-cannonlake linux-modules-extra-4.20.0-dragon-cannonlake
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-zen linux-image-unsigned-4.20.0-dragon-zen linux-modules-4.20.0-dragon-zen linux-modules-extra-4.20.0-dragon-zen
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/zen-excavator
$ sudo apt-get update
$ sudo apt install linux-headers-4.20.0-dragon linux-headers-4.20.0-dragon-excavator linux-image-unsigned-4.20.0-dragon-excavator linux-modules-4.20.0-dragon-excavator linux-modules-extra-4.20.0-dragon-excavator
$ sudo reboot
```
