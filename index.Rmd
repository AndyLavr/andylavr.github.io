---
title: "Dragon Linux Kernel 4.19.1"
...
**Sources are on Launchpad. You can see and check them. From these sources, buildbox Launchpad builds packages in a clean environment. Everything is officially and verified by Launchpad and Cannonical.**
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.1-dragon linux-headers-4.19.1-dragon-generic linux-image-unsigned-4.19.1-dragon-generic linux-modules-4.19.1-dragon-generic linux-modules-extra-4.19.1-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/generic
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.1-dragon linux-headers-4.19.1-dragon-lowlatency linux-image-unsigned-4.19.1-dragon-lowlatency linux-modules-4.19.1-dragon-lowlatency linux-modules-extra-4.19.1-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.1-dragon linux-headers-4.19.1-dragon-westmere linux-image-unsigned-4.19.1-dragon-westmere linux-modules-4.19.1-dragon-westmere linux-modules-extra-4.19.1-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wip-kernel-release
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.1-dragon linux-headers-4.19.1-dragon-atom linux-image-unsigned-4.19.1-dragon-atom linux-modules-4.19.1-dragon-atom linux-modules-extra-4.19.1-dragon-atom
$ sudo reboot
```
...
[![Download](https://img.shields.io/badge/Download-westmere-yellow.svg)](https://goo.gl/vPPQ3A)
[![Download](https://img.shields.io/badge/Dowload-atom-red.svg)](https://goo.gl/vPPQ3A)
[![Download](https://img.shields.io/badge/Download-generic-green.svg)](https://goo.gl/4v8yr9)
[![Download](https://img.shields.io/badge/Download-lowlatency-yellowgreen.svg)](https://goo.gl/4v8yr9)
