---
title: "Dragon Linux Kernel 5.0.1"
subtitle: "For distributives based on Ubuntu Cosmic/Disco"
date: "`r Sys.Date()`"
permalink: /
---
...
Maximum support for devices operation only if the system is installed from the ([Dragon Live disk](https://dragon-kernel.pro/livedvd))
...
```
major.minor[.maintenance-build]  (Example: 5.0.1-dragon)
...
All workstations that I use today — a [MSI GT80-2QE-Titan-SLI (Broadwell)](https://www.msi.com/Laptop/GT80-2QE-Titan-SLI/Specification), [Dell Inspiron N5010 (Westmere)](https://technoish.com/dell-inspiron-n5010-review/), [Toshiba Satellite Click 10 LX0W-C - C64M (Atom Cherry Trail)](http://www.toshiba.co.uk/discontinued-products/satellite-click-10-lx0w-c-104/?categoryNameProductPage=laptops) and [Acer Aspire SW5-012/Fendi2 Z3537F (Atom Bay Trail)](https://www.cnet.com/products/acer-aspire-switch-10-sw5-012-12l7-10-1-atom-z3735f-2-gb-ram-32-gb-ssd/specs/)  - boots Dragon kernels instead. Dragon’s kernels mirror the upstream development cycle, and as a bonus, include a number of exciting optimizations and patches to improve performance and expose up-and-coming features.
...
## Linux X64 (AMD64/EM64T) display kernel module
 ...
 Full information is driver version **390.116** here - ([Nvidia Main site](https://www.nvidia.com/Download/driverResults.aspx/142567/en-us))
...
This may interact better with the rest of your distribution's framework, and you may want to use this rather than NVIDIA's official package.
 ...
 - The modules nvidia* version 390.116 is integrated into the kernel.
...
#### Warning! This kernel implement OpenZFS version 0.7.13.
 ...
 **Linux read/write kernel driver for the exFAT(FAT64), FAT12, FAT16 and vfat (FAT32) file systems** 
 ...
 - Full adaptation to Kernel 5.0.y
...
Dragon Team cannot guarantee the maximum support for the operation of the device as it is unknown whether the necessary libraries and firmware are installed in the system or not.
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.1-dragon linux-headers-5.0.1-dragon-generic linux-image-unsigned-5.0.1-dragon-generic linux-modules-5.0.1-dragon-generic linux-modules-extra-5.0.1-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/genv5
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.1-dragon linux-headers-5.0.1-dragon-lowlatency linux-image-unsigned-5.0.1-dragon-lowlatency linux-modules-5.0.1-dragon-lowlatency linux-modules-extra-5.0.1-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.1-dragon linux-headers-5.0.1-dragon-westmere linux-image-unsigned-5.0.1-dragon-westmere linux-modules-5.0.1-dragon-westmere linux-modules-extra-5.0.1-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wav5pax
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.1-dragon linux-headers-5.0.1-dragon-atom linux-image-unsigned-5.0.1-dragon-atom linux-modules-5.0.1-dragon-atom linux-modules-extra-5.0.1-dragon-atom
$ sudo reboot
```
