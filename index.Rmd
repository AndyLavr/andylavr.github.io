---
title: "Dragon Linux Kernel 5.0.3"
...
```
major.minor[.maintenance-build]  (Example: 5.0.3-dragon)
...
volume managers, and more, with consistent reliability, functionality and performance.
 ...
 - The module OpenZFS is integrated into the kernel (only GENERIC kernel build).
...
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.3-dragon linux-headers-5.0.3-dragon-generic linux-image-unsigned-5.0.3-dragon-generic linux-modules-5.0.3-dragon-generic linux-modules-extra-5.0.3-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/genv5
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.3-dragon linux-headers-5.0.3-dragon-lowlatency linux-image-unsigned-5.0.3-dragon-lowlatency linux-modules-5.0.3-dragon-lowlatency linux-modules-extra-5.0.3-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.3-dragon linux-headers-5.0.3-dragon-westmere linux-image-unsigned-5.0.3-dragon-westmere linux-modules-5.0.3-dragon-westmere linux-modules-extra-5.0.3-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wav5pax
$ sudo apt-get update
$ sudo apt install linux-headers-5.0.3-dragon linux-headers-5.0.3-dragon-atom linux-image-unsigned-5.0.3-dragon-atom linux-modules-5.0.3-dragon-atom linux-modules-extra-5.0.3-dragon-atom
$ sudo reboot
```
