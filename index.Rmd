---
title: "Dragon Linux Kernel 4.19.8"
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-generic linux-image-unsigned-4.19.8-dragon-generic linux-modules-4.19.8-dragon-generic linux-modules-extra-4.19.8-dragon-generic
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/generic
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-lowlatency linux-image-unsigned-4.19.8-dragon-lowlatency linux-modules-4.19.8-dragon-lowlatency linux-modules-extra-4.19.8-dragon-lowlatency
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-westmere linux-image-unsigned-4.19.8-dragon-westmere linux-modules-4.19.8-dragon-westmere linux-modules-extra-4.19.8-dragon-westmere
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/wip-kernel-release
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-atom linux-image-unsigned-4.19.8-dragon-atom linux-modules-4.19.8-dragon-atom linux-modules-extra-4.19.8-dragon-atom
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-icelake linux-image-unsigned-4.19.8-dragon-icelake linux-modules-4.19.8-dragon-icelake linux-modules-extra-4.19.8-dragon-icelake
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/icelake-cannonlake
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-cannonlake linux-image-unsigned-4.19.8-dragon-cannonlake linux-modules-4.19.8-dragon-cannonlake linux-modules-extra-4.19.8-dragon-cannonlake
$ sudo reboot
```
...
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-zen linux-image-unsigned-4.19.8-dragon-zen linux-modules-4.19.8-dragon-zen linux-modules-extra-4.19.8-dragon-zen
$ sudo reboot
```
...
$ sudo add-apt-repository ppa:wip-kernel/zen-excavator
$ sudo apt-get update
$ sudo apt install linux-headers-4.19.8-dragon linux-headers-4.19.8-dragon-excavator linux-image-unsigned-4.19.8-dragon-excavator linux-modules-4.19.8-dragon-excavator linux-modules-extra-4.19.8-dragon-excavator
$ sudo reboot
```
