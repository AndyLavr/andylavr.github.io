...
```
$ sudo sbsign --key /var/lib/shim-signed/mok/MOK.priv --cert ~/MOK.pem /boot/vmlinuz-5.0.3-dragon-generic --output /boot/vmlinuz-5.0.3-dragon-generic.signed
$ sudo cp /boot/initrd.img-5.0.3-dragon-generic{,.signed}
$ sudo update-grub
$ reboot
```
...
```
$ sudo mv /boot/vmlinuz-5.0.3-dragon-generic{.signed,} 
$ sudo mv /boot/initrd.img-5.0.3-dragon-generic{.signed,}
$ sudo update-grub
$ reboot
```
