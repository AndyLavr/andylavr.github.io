...
GRUB_CMDLINE_LINUX="noresume systemd.gpt_auto=0 zswap.enabled=1 zswap.compressor=lz4 zswap.max_pool_percent=30"
...
```bash
GRUB_CMDLINE_LINUX="zswap.compressor=lz4 zswap.max_pool_percent=30"
