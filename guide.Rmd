...
```
 ...
 Sign your kernel: sudo sbsign --key /var/lib/shim-signed/mok/MOK.priv --cert ~/MOK.pem /boot/vmlinuz-5.0.3-dragon --output /boot/vmlinuz-5.0.3-dragon.signed

```
$ sudo cp /boot/initrd.img-5.0.3-dragon<open curly brace>,.signed<close curly brace>
$ sudo update-grub
$ reboot
``
...
```
$ sudo mv /boot/vmlinuz-5.0.3-dragon<open curly brace>.signed,<close curly brace> and sudo mv /boot/initrd.img-5.0.3-dragon<open curly brace>.signed,<close curly brace>
$ sudo update-grub
$ reboot
```
