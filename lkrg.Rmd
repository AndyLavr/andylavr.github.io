...
filename:       /lib/modules/4.20.11-dragon-westmere/kernel/drivers/staging/lkrg/lkrg.ko
version:        0.6a-dragon
license:        GPL v2
...
intree:         Y
name:           lkrg
vermagic:       4.20.11-dragon-westmere SMP mod_unload 
sig_id:         PKCS#7
signer:
sig_key:
sig_hashalgo:   md4
...
[Download](https://dragon-kernel.pro/files/install_lkrg-service.tar.gz) install scripts, unpack and run scripts:
