...
filename:       /lib/modules/4.19.0-041900.201810221809-westmere/kernel/drivers/staging/lkrg/lkrg.ko
license:        GPL v2
description:    'pi3's Linux kernel Runtime Guard
author:         Adam 'pi3' Zabrocki (http://pi3.com.pl)
srcversion:     55B570DD224083E27457CD8
depends:        
staging:        Y
retpoline:      Y
intree:         Y
name:           lkrg
vermagic:       4.19.0-041900.201810221809-westmere SMP mod_unload 
sig_id:         PKCS#7
signer:         
sig_key:        
sig_hashalgo:   md4
