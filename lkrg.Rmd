...
filename:       /lib/modules/4.15.7-wip-x30-broadwell/kernel/drivers/staging/lkrg/lkrg.ko
license:        GPL v2
...
intree:         Y
name:           lkrg
vermagic:       4.15.7-wip-x30-broadwell SMP mod_unload modversions retpoline
signat:         PKCS#7
signer:
sig_key:
sig_hashalgo:   md4
