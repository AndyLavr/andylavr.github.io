...
filename:       /lib/modules/4.19.1-dragon-westmere/kernel/drivers/staging/lkrg/lkrg.ko
license:        GPL v2
description:    pi3s Linux kernel Runtime Guard
author:         Adam 'pi3' Zabrocki (http://pi3.com.pl)
srcversion:     FC44FBFE3805FC7B7981F74
depends:        
staging:        Y
retpoline:      Y
intree:         Y
name:           lkrg
vermagic:       4.19.1-dragon-westmere SMP mod_unload 
sig_id:         PKCS#7
signer:         
sig_key:        
sig_hashalgo:   md4
